...
def test_listen(host):
    h_ip = {
        'instance1-corosync-default': '192.168.168.2',
        'instance2-corosync-default': '192.168.168.3',
        'instance3-corosync-default': '192.168.168.4',
    }
...
def test_transport(host):
    ...
    assert b'Initializing transport (Kronosnet)' in f.content
